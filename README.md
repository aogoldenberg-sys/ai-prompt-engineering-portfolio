...
| Languages | Python, JavaScript (Node / Workers), TypeScript |
| Other | Serverless architecture, payment integrations, CRM design, legal-tech AI pipelines |
...
### 4 · AI Legal Compliance Analyser
...
| Языки | Python, JavaScript / TypeScript (Node / Workers) |
| Прочее | Serverless-архитектура, интеграции с платёжными системами, проектирование CRM, legal-tech AI |
...
### 4 · AI-анализатор юридических предписаний
